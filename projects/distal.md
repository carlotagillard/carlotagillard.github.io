...
<div style="display: flex; align-items: center; gap: 30px;">
  <img src="../images/distal/final poster.png" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <p>
...
## The Tech
<div style="display: flex; align-items: center; gap: 30px;">
  <img src="../images/distal/First few prints2.jpeg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <img src="../images/distal/First few prints4.jpeg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <p>
...
📐 [OnShape](https://cad.onshape.com/documents/eb6e289ed05d07266b6ba426/w/ca134d3ec821955ecd2be735/e/05d6ec63819e9a8e71cf58d3?renderMode=0&uiState=69ffd5afb76ab8a5a7d93add)

## The Work & Results
<div style="display: flex; align-items: center; gap: 30px;">
  <img src="../images/distal/TeamPicture.jpeg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <img src="../images/distal/final vertical fractured.jpg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <p>
...
<div style="display: flex; align-items: center; gap: 30px;">
  <img src="../images/distal/Testing at Hospital.jpeg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <p>
    Image of ER doctors trying to reduce the Model.
  </p>
  <img src="../images/distal/BroderTestWResidents.jpeg" alt="Carlota Gillard" width="250" style="border-radius: 10px;">
  <p>
    Image of Dr. Josh Broder with one of his Orthopedic Residents utilizing the model arm.
  </p>
</div>

▶️ [Prototype Video](https://cad.onshape.com/documents/eb6e289ed05d07266b6ba426/w/ca134d3ec821955ecd2be735/e/05d6ec63819e9a8e71cf58d3?renderMode=0&uiState=69ffd5afb76ab8a5a7d93add](https://youtu.be/4MaEyghUxlk?si=pkknUj1XprWyjo1m)) 
