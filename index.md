...
Firmware, a custom KiCad PCB, and a 3D-printed enclosure in one battery-powered device. Three LEDs on independent timers with a heartbeat holding 1 Hz to within 0.5%, characterized against spec with measured data.<br>
*C++ · KiCad · OnShape · PlatformIO*

### [Distal Forearm Fracture Model](/projects/distal.html)
A training device for orthopedic residents, built around a guided maze that enforces the reduction motion rather than just the endpoint. Eight physicians rated the mechanism 8.3 out of 10.<br>
